...
const promise3 = new Promise((resolve, reject)=>{
    document.addEventListener("mousedown", (e)=>{
        ...
        if (leftClick && rightClick) {
            ...
            resolve(body.append(div));
        } else reject(new Error("You don`t click left mouse or right mouse"));
    });
});
promise1.then((success)=>success, (error)=>error);
promise2.then((success)=>success, (error)=>error);
promise3.then((success)=>success, (error)=>error);
